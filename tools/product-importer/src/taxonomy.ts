...
const TAG_RULES: Record<string, TagRule> = {
  ...
  "REB-MEN TOP": { gender: "men", department: "tops" },
  "RBC- TOPS MEN": { gender: "men", department: "tops" },
  "REB-MEN BOTTOMS": { gender: "men", department: "bottoms" },
  "RBC- BOTTOMS MEN": { gender: "men", department: "bottoms" },
  "REB-WOMEN TOPS": { gender: "women", department: "tops" },
  "RBC- TOPS WOMEN": { gender: "women", department: "tops" },
  "REB-WOMEN BOTTOMS": { gender: "women", department: "bottoms" },
